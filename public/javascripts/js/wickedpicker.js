            ...
            var clickHandler = function (event) {
                ...
                if ($(self.timepicker).is(':visible')) {
                    ...
                    if ($(event.target).is(self.close)) {
                        ...
                        //console.log(self.element.attr('name'),self.timepicker,$(event.target).attr('name'));
                        //console.log($(event.target),$(event.target).closest(self.timepicker).length,' || ',$(event.target).closest($('.hasWickedpicker')).length,$('.hasWickedpicker'))
